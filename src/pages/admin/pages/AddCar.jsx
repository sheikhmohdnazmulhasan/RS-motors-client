...
const AddCar = () => {
    ...
    async function handleAddCar(event) {
        ...
        if (response.data.success == true) {
            ...
            const data = { features, title, fuelType, year, mileage, price, bodyType, condition, transmissionType, regionalSpec, steeringSide, photo: response.data.data.display_url };


            axios.post('http://localhost:5000/add-car/v1', data).then(data => {
        ...
        <div>
            ...
            <form className="max-w-md mx-auto" onSubmit={handleAddCar}>
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <input type="number" name="price" id="floating_first_name" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
